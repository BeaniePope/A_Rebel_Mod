class HCA_lr_radio_dialog
{
    idd = 9991;
    movingEnable = 1;
    controlsBackground[] = { };
    objects[] = { };
    onUnload = "['OnRadioOpen', [player, TF_lr_dialog_radio, false, 'HCA_lr_radio_dialog', false]] call TFAR_fnc_fireEventHandlers;";
    onLoad = "if (sunOrMoon < 0.2) then {((_this select 0) displayCtrl 1200) ctrlSetText 'HCA_core\TFAR\TFAR_Radios\ui\hclr.paa'};";
    controls[]= {
        "background",
        "volume_Switch",
        "next_channel",
    ...
    class background: RscBackPicture
    {
        idc = 1200;
        moving = 1;
        text = "HCA_core\TFAR\TFAR_Radios\ui\hclr.paa";
    ...
    class clear: HiddenButton
    {
        ...
        h = "0.0564 * safezoneH";
        tooltip = "Clear";
        action = "ctrlSetText [IDC_HCA_lr_EDIT, '']; ctrlSetFocus ((findDisplay 9990) displayCtrl IDC_HCA_lr_EDIT);";
    ...
    class enter: HiddenButton
    {
        ...
        h = "0.0564 * safezoneH";
        tooltip = "enter";
        onButtonClick = QUOTE([((ctrlParent (_this select 0))) displayCtrl IDC_HCA_lr_EDIT] call TFAR_backpacks_fnc_onButtonClick_Enter;);
        action = "";
    };
    ...
    class edit: RscEditLCD
    {
        ...
        onKeyUp = QUOTE( \
            if (_this select 1 in [ARR_2(28,156)]) then { \
                [((ctrlParent (_this select 0))) displayCtrl IDC_HCA_lr_EDIT] call TFAR_backpacks_fnc_onButtonClick_Enter; \
            }; \
        );
    };
};
