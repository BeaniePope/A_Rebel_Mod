class commlink_radio_dialog
{
    ...
    onLoad = "if (sunOrMoon < 0.2) then {((_this select 0) displayCtrl 1299) ctrlSetText '\HCA_Core\TFAR\TFAR_Radios\ui\commlink_n.paa';};";    
    controls[]= {
        "background",
        "channel_01",
        "channel_02",
    ...
    {
        idc = 1299;
        text = "HCA_Core\TFAR\TFAR_Radios\ui\commlink.paa";
